...
<%
    ...
    Usuario user = (Usuario)objSes.getAttribute("login");
...
<% } else if(user.getIDTipoUsuario()==3){%> <!--Si el tipo de usuario está definido y es un cliente o colaborador, muestra este header: -->
<div id="layoutDefault_content">
            <main>
                <nav class="navbar navbar-marketing navbar-expand-lg navbar-light" style="background-color:001B37 ;">
                    <div class="container">
